...
def upgrade() -> None:
    ...
    # Promote property presentation metadata out of the unvalidated attributes bag. Existing
    # cover/floorplan URLs have an authoritative one-to-one mapping; unknown parking and location
    # data remain NULL rather than being guessed.
